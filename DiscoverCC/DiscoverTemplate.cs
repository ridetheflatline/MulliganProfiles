    ...
    internal class DiscoverTemplate : DiscoverPickHandler
    {
        ...
        private Card.Cards JeweledScarabHandler(List<Card.Cards> choices, Board board, BoardState boardCondition)
        {
            Dictionary<Card.Cards, int> jeweledScarabList = new Dictionary<Card.Cards, int>
            {
                ...
                {Cards.BigGameHunter, HasBghTarget(board) ? 100 : 0},
                {Cards.AlarmoBot, 0},
        ...
        private Card.Cards GorillabotA3Handler(List<Card.Cards> choices, Board board, BoardState boardCondition)
        {
            Dictionary<Card.Cards, int> gorilaBotList = new Dictionary<Card.Cards, int>
            {
                ...
                {Cards.Snowchugger, 0},
                {Cards.FlameLeviathan, 0},
                {Cards.SootSpewer, 0},
                {Cards.ShieldedMinibot, 0},
                {Cards.CobaltGuardian, 0},
                {Cards.Warbot, 0},
                {Cards.ScrewjankClunker, 0},
                {Cards.IronJuggernaut, 0},
                {Cards.SiegeEngine, 0},
                {Cards.FelCannon, 0},
                {Cards.AnimaGolem, 0},
                {Cards.MetaltoothLeaper, 0},
        ...
        private bool HasBghTarget(Board board)
        {
            return board.MinionEnemy.Any(c => c.Template.Atk >= 7);
        }
