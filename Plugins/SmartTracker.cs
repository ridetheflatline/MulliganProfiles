...
namespace SmartBot.Plugins
{
    ...
    public class SmTracker : Plugin
    {
        ...
        private void UpdateTracker(string lSmartTracker, string remoteVer, string localVer)
        {
            ...
            HttpWebRequest trackeRequest = WebRequest.Create("https://raw.githubusercontent.com/ArthurFairchild/MulliganProfiles/SmartMulliganV3/Plugins/Arthurs%20Bundle%20-%20Tracker.cs") as HttpWebRequest;
        ...
        public DeckData GetDeckInfo(Card.CClass cClass, List<string> curDeck, int activeSecrets = 0)
        {
            ...
            switch (cClass)
            {
                ...
                int[] TotemShamans = new int[4] {CurrentDeck.Intersect(TotemShaman).Count(),
