        ...
        public DeckData GetDeckInfo(Card.CClass ownClass, List<string> curDeck, int activeSecrets = 0)
        {
            ...
            switch (ownClass)
            {
                ...
                case Card.CClass.SHAMAN:
                    ...
                    if (CurrentDeck.ContainsSome(Cards.Doomsayer, Cards.BigGameHunter, Cards.ElementalDestruction,
                        Cards.HealingWave, Cards.LightningStorm, Cards.JeweledScarab))
                    {
                ...
                case Card.CClass.MAGE:
                    ...
                    if (CurrentDeck.RaceCount(Card.CRace.MECH) > 3 ||
                        CurrentDeck.ContainsSome(Cards.ClockworkGnome, Cards.Mechwarper, Cards.SpiderTank,
                            Cards.TinkertownTechnician, Cards.Snowchugger))
                    {
                ...
                case Card.CClass.WARRIOR:
                    ...
                    if (CurrentDeck.ContainsAtLeast(2, Cards.Bolster, Cards.SparringPartner, Cards.FierceMonkey,
                        Cards.ObsidianDestroyer, Cards.ArcaneNullifierX21))
                    {
                ...
                case Card.CClass.WARLOCK:
                    ...
                    if (CurrentDeck.ContainsAtLeast(2, Cards.JeweledScarab, Cards.AntiqueHealbot, Cards.Ysera,
                        Cards.EmperorThaurissan, Cards.EliseStarseeker, Cards.Demonfire, Cards.Hellfire,
                        Cards.SiphonSoul))
                    {
                    ...
                    if (CurrentDeck.ContainsAtLeast(2, Cards.Voidcaller, Cards.Doomguard, Cards.MalGanis,
                        Cards.ImpGangBoss))
                    {
                ...
                case Card.CClass.HUNTER:
                    ...
                    if (CurrentDeck.RaceCount(Card.CRace.DRAGON) > 3 ||
                        CurrentDeck.ContainsAtLeast(2, Cards.TwilightGuardian, Cards.BlackwingTechnician,
                            Cards.BlackwingCorruptor, Cards.DrakonidCrusher, Cards.RendBlackhand))
                    {
                    ...
                    if (CurrentDeck.ContainsAtLeast(2, Cards.ExplosiveTrap, Cards.AbusiveSergeant, Cards.LeperGnome,
                        Cards.KnifeJuggler))
                    {
                ...
                case Card.CClass.DRUID:
                    ...
                    if (CurrentDeck.RaceCount(Card.CRace.BEAST) > 3 ||
                        CurrentDeck.ContainsAtLeast(2, Cards.HauntedCreeper, Cards.MountedRaptor, Cards.Wildwalker,
                            Cards.DruidoftheFang))
                    {
                    ...
                    if (CurrentDeck.QualityCount(Card.CQuality.Legendary) > 4 ||
                        CurrentDeck.Contains(Cards.AstralCommunion))
                    {
                    ...
                    if (CurrentDeck.RaceCount(Card.CRace.MECH) > 1 ||
                        CurrentDeck.ContainsSome(Cards.Cogmaster, Cards.AnnoyoTron, Cards.Mechwarper,
                    ...
                    if (CurrentDeck.ContainsSome(Cards.ColdlightOracle, Cards.Naturalize, Cards.GroveTender,
                        Cards.TreeofLife, Cards.YouthfulBrewmaster))
                    {
                    ...
                    if (CurrentDeck.ContainsAtLeast(2, Cards.RagnarostheFirelord, Cards.AncientofWar, Cards.Cenarius,
                        Cards.SylvanasWindrunner, Cards.TheBlackKnight, Cards.SludgeBelcher, Cards.ZombieChow, Cards.SenjinShieldmasta))
                    {
                    ...
                    if (CurrentDeck.ContainsSome(Cards.LeperGnome, Cards.MountedRaptor, Cards.FelReaver,
                        Cards.DruidoftheSaber, Cards.KnifeJuggler))
                    {
