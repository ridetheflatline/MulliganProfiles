...
namespace SmartBot.Plugins
{
    ...
    public class SmTracker : Plugin
    {
        ...
        private readonly List<Card.Cards> FaceShaman2 = new List<Card.Cards> { Cards.AbusiveSergeant, Cards.AbusiveSergeant, Cards.ArgentSquire, Cards.ArgentSquire, Cards.LightningBolt, Cards.LightningBolt, Cards.RockbiterWeapon, Cards.RockbiterWeapon, Cards.SirFinleyMrrgglton, Cards.TunnelTrogg, Cards.TunnelTrogg, Cards.FlameJuggler, Cards.FlametongueTotem, Cards.FlametongueTotem, Cards.TotemGolem, Cards.TotemGolem, Cards.ArgentHorserider, Cards.ArgentHorserider, Cards.FeralSpirit, Cards.FeralSpirit, Cards.LavaBurst, Cards.LavaBurst, Cards.TuskarrTotemic, Cards.TuskarrTotemic, Cards.FlamewreathedFaceless, Cards.FlamewreathedFaceless, Cards.Doomhammer, Cards.Doomhammer, Cards.ThingfromBelow, Cards.ThingfromBelow};
        ...
        public DeckData GetDeckInfo(Card.CClass cClass, List<string> curDeck, int activeSecrets = 0)
        {
            ...
            switch (cClass)
            {
                ...
                if (CurrentDeck.Contains(Cards.Malygos))
                {
                    ...
                    int[] fshaman = new int[]
                    {
                        CurrentDeck.Intersect(FaceShaman).Count(),
                        CurrentDeck.Intersect(FaceShaman2).Count(),

                    };
                deckDictionary.AddOrUpdate(DeckType.FaceShaman, fshaman.Max());
